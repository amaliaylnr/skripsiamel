...
<section class="masthead berita" id="berita">
    <div class="container">
        ...
        <div class="row justify-content-center">
            <h2 class="text-center m-4">FORMULIR PENGAJUAN SURAT KETERANGAN DOMISILI</h2>
            <!-- berita Item 1-->
                ...
                <div class="berita-item mx-auto border-2">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="/pengajuan/form_domisili_proses" method="post" enctype="multipart/form-data">
                                <?= csrf_field(); ?>
                                <div class="row">
