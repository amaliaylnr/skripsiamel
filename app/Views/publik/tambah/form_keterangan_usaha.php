...
<section class="masthead berita" id="berita">
    <div class="container">
        ...
        <div class="row justify-content-center">
            <h2 class="text-center m-4">FORMULIR PENGAJUAN SURAT KETERANGAN USAHA</h2>
            <!-- berita Item 1-->
                ...
                <div class="berita-item mx-auto border-2">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="/pengajuan/form_keterangan_usaha_proses" method="post" enctype="multipart/form-data">
                                <?= csrf_field(); ?>
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-sm-12 mb-2">
                                        ...
                                        <div class="col-lg-12 col-sm-12 ml-lg-0 mb-2">
                                            <label for="">Keperluan Surat <small>*edit untuk disesuaikan dengan kebutuhan surat</small></label>
                                            <textarea name="keperluan" id="" class="form-control" cols="30" rows="3" placeholder="Jelaskan keperluan surat..." value="<?= set_value('keperluan') ?>">Surat Pengantar ini dipergunakan ke Bank untuk sebagai syarat pengajuan pinjaman KUR</textarea>
                                        </div>
                                        ...
                                        <div class="col-lg-12 col-sm-12 ml-lg-0 mb-2">
                                            <label for="">Keterangan Lainnya <small>*edit untuk disesuaikan dengan kebutuhan surat</small></label>
                                            <textarea name="keterangan" id="" class="form-control" cols="30" rows="6" value="<?= set_value('keterangan') ?>">Ybs. adalah warga Desa Plawikan yang benar-benar mempunyai Usaha Pembuatan ........</textarea>
                                        </div>
