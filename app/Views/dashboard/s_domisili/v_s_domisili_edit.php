...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form action="/surat/s_domisili_edit_proses/<?= $s_domisili['id'] ?>" method="post" enctype="multipart/form-data">
            <?= csrf_field(); ?>
            <div class="row">
                ...
                <div class="col-lg-6 col-sm-12 mb-2">
                    ...
                    <div class="col-lg-12 col-sm-12 ml-lg-0 mb-2">
                        ...
                        <textarea name="keperluan" id="" class="form-control" cols="30" rows="3" placeholder="Jelaskan keperluan surat..." value="<?= $s_domisili['keperluan']  ?>"><?= $s_domisili['keperluan']  ?></textarea>
                    </div>
                    
                    <div class="col-lg-12 col-sm-12 ml-lg-0 mb-2">
                        <label for="">Pengambilan Surat</label>
                        <select name="pengambilan" id="" class="custom-select">
                            <option selected value="<?= $s_domisili['pengambilan'] ?>"><?= $s_domisili['pengambilan']  ?></option>
