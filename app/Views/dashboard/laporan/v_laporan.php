                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="d-block">
                            ...
                            <a href="/surat/s_pengantar_delete/<?=$pntr['id'];?>" class="btn btn-sm btn-danger" onclick="return confirm('Apakah anda yakin hapus data?');"><i class="fas fa-trash"></i></a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="/surat/s_domisili_delete/<?=$prhn['id'];?>" class="btn btn-sm btn-danger"><i class="fas fa-trash" onclick="return confirm('Apakah anda yakin hapus data?');"></i></a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="/surat/s_keterangan_delete/<?=$ktrn['id'];?>" class="btn btn-sm btn-danger"><i class="fas fa-trash" onclick="return confirm('Apakah anda yakin hapus data?');"></i></a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="/surat/s_kematian_delete/<?=$kmtn['id'];?>" class="btn btn-sm btn-danger"><i class="fas fa-trash" onclick="return confirm('Apakah anda yakin hapus data?');"></i></a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
