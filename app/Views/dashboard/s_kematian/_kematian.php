...
<div class="card shadow mb-4">
    <div class="card-header py-3 d-flex">
        ...
        <a href="/surat/s_kematian" class="btn btn-create btn-icon-split text-white">
            <span class="icon text-white btn-edit">
                <i class="fas fa-arrow-alt-circle-left fa-2x"></i>
            </span>
        </a>
        <a href="/surat/cetak_s_kematian/<?= $surat_->id; ?>" class="btn btn-primary btn-icon-split text-white ml-2" target="_blank">
            <span class="icon text-white btn-edit">
        ...
        <div class="card mb-4 mt-4">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        <p class="text-muted mb-0"><?= $surat_->nama; ?> (Almarhum)</p>
                    </div>
                </div>
                <hr>
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        <p class="text-muted mb-0">
                            <?php 
                            $newDate = strftime("%d %B %Y", strtotime($surat_->tgl_kelahiran));
                            ?>
                            <?= $surat_->tempat_lahir.', '.
                            $newDate;
                            ?>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        <p class="text-muted mb-0">
                            <?php 
                            $newDate = strftime("%d %B %Y", strtotime($surat_->tgl_meninggal));
                            ?>
                            <?=
                            $newDate;
                            ?>
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <p class="mb-0">Usia Meninggal</p>
                    </div>
                    <div class="col-sm-9">
                        <p class="text-muted mb-0"><?= $surat_->umur; ?> Tahun</p>
                    </div>
                </div>
                <hr>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <p class="mb-0">Keterangan Surat</p>
                    </div>
                    <div class="col-sm-9">
                        <p class="text-muted mb-0"><?= $surat_->keterangan; ?></p>
                    </div>
                </div>
            </div>
        </div>
