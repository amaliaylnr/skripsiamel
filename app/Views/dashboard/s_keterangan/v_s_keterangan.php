    ...
    <div class="card-body">
        ...
        <table class="table table-bordered d-sm-table-cell small" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    <?php
                    $no=1;  
                    foreach ($surat_keterangan as $item):
                    ?>
                    <tr>
                        <td><?= $no++; ?></td>
                        <td><?= $item['nama']; ?></td>
                        ...
                        <td class="d-flex">
                            ...
                            ?>
                                ...
                                <a href="<?= base_url('/surat/s_keterangan/view/'.$item['id']); ?>" class="btn btn-edit btn-rounded text-white ml-2">
                            ...
                            ?>
                                <a href="<?= base_url('/surat/s_keterangan/view/'.$item['id']); ?>" class="btn btn-edit btn-rounded text-white">
                                    <i class="fas fa-eye"></i>
                                </a>
                            ...
                            <a href="<?= base_url('/surat/s_keterangan_delete/' . $item['id']); ?>" class="btn btn-delete btn-rounded text-white ml-2" onclick="return confirm('Apakah anda yakin ?');">
