...
<div class="card shadow mb-4">
    <div class="card-header py-3 d-flex">
        ...
        <a href="/surat/s_keterangan_usaha" class="btn btn-create btn-icon-split text-white">
            <span class="icon text-white btn-edit">
                <i class="fas fa-arrow-alt-circle-left fa-2x"></i>
            </span>
        </a>
        <a href="/surat/cetak_s_ket_usaha/<?= $surat_->id; ?>" class="btn btn-primary ml-2 btn-icon-split text-white" target="_blank">
            <span class="icon text-white btn-edit">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <?= $surat_->tempat_lahir.", ".strftime("%d %B %Y", strtotime($surat_->tgl_lahir)); ?>
                        </p>
                    </div>
                </div>
                <hr>
