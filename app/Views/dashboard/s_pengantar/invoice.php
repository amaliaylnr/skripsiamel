...
<div class="header-surat">
    <br>
    <hr class="garis1 mt-2"/>
    <p style="font-size:18pt;text-align:center subject">SURAT KETERANGAN USAHA <br>
    <b style="font-size:11pt;text-align:center no-surat">No: 510 / ......  / 20.01</b></p>
</div>
...
<table cellpadding="4" >
    <tr>
        ...
        <td width="50%" style="height: 20px;text-align:center">
            <p>Gresik, <?= date('d M Y'); ?><br>Hormat kami,</p>
            <p></p>
            <p></p>
            <p></p>
            <p></p>
            <p><b><u>Kepala Pemkab</u></b></p>
        </td>
    </tr>
</table>